...
import com.sccf.auth.service.UserDetailsImpl;
...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		RestResponse<AuthUserVo> responseEntity = userFeignApi.findUserByMobile((String) ajaxAuthenticationToken.getPrincipal());
		...
		AuthUserVo user = responseEntity.getResult();
	...
	private UserDetailsImpl buildUserDeatils(AuthUserVo authUser) {
	...
	public IUserFeignService getUserFeignApi() {
		return userFeignApi;
	}

	public void setUserFeignApi(IUserFeignService userFeignApi) {
