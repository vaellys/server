...
import com.sccf.core.configuration.FwUrlsConfiguration;
import com.sccf.gateway.filter.ValidateCodeFilter;
import com.sccf.gateway.handler.AccessDeniedHandler;
...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            JSON.writeJSONString(outputStream, restResponse);
        };
    }
}
